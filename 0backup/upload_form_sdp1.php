...
<h2>Choise</h2>
		...
		<table style='width: 50%'>
			...
			<tr>
				<td colspan='6'>
				<form id='uploadform'  enctype='multipart/form-data' action='uploadSDP.php'  method='post'>
					<div id='div1'>
						<div>
							<p>
                            ...
                            <input  type='submit' name='typedb'  value='demandtown_sdp'  />
							</p>
						</div>
					</div>
					<div id='div2'>
						<div>
                          ...
                          <input  type='submit' name='typedb'  value='demandagriculture_sdp'  />
					...
					<div id='div3'>
						<div>
                            ...
                            <input  type='submit' name='typedb'  value='demandecology_sdp'  />
					...
					<div id='div4'>
						<div>
                            ...
                            <input  type='submit' name='typedb'  value='flood_sdp'  />
                    ...
                    <div id='div5'>
						<div>
							...
							<input  type='submit' name='typedb'  value='recreation_sdp' />
					...
					<div id='div6'>
						<div>
							...
							<input name='ufile' type='file' />
                            <input  type='submit' name='typedb'  value='storage_sdp'  />
							<input type='hidden' value='uploadSDP' name='uploadSDP' />
