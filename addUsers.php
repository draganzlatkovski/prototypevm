...
<div class="headtitle">    
   <input type = 'button'  align="right" value = ' How to use the application    ' onClick='PopUpW()'></input>
   <a href="app.php"><input type='button' align="right" value='Back to application'></input></a>
   </span>
<input type = 'button' class="olLogout" onClick='PopUpLogout()' value = ' Logout    '  align="left"></input>
	<h2 id="title" style="margin-top:-15px;">
     <center>     
      Use this form to add and manage users 
     </center>
    </h2>	
</div>
	<div id="output-id" style="">
	<?php
	session_start();
	if( isset($_SESSION['ERRMSGV1_ARR']) && is_array($_SESSION['ERRMSGV1_ARR']) && count($_SESSION['ERRMSGV1_ARR']) >0 )
	{
	echo '<hr><p>';
	echo '<ul class="err">';
	foreach($_SESSION['ERRMSGV1_ARR'] as $msg)
	{
	echo '<li>',$msg,'</li>'; 
	}
	echo '</ul></p>';
	unset($_SESSION['ERRMSGV1_ARR']);
	}
	?>
	...
	<td><input type="text" name="username" maxlength="50" autocomplete="off" required ></input></td>
	</tr>
	<tr>
	<td><div align="right">Enter password:</div></td>
	<td><input type="password" name="password" maxlength="50" autocomplete="off" required></input></td>
	</tr>
	<tr>
	<td><div align="right">Re-enter password:</div></td>
	<td><input type="password" name="cpassword" maxlength="50" autocomplete="off" required></input></td>
	</tr>
	<tr>
	<td><div align="right">Enter name and surname:</div></td>
	<td><input type="text" name="name_surname" maxlength="50" autocomplete="off"></input></td>
	</tr>
	<tr>
	<td><div align="right">Enter city name:</div></td>
	<td><input type="text" name="city" maxlength="50" autocomplete="off"></input></td>
	</tr>
	<tr>
	<tr>
	<td><div align="right">Enter country:</div></td>
...
echo "<td>".$red['nameSurname']."&nbsp;&nbsp;</td>";
echo "<td>".$red['city']."&nbsp;&nbsp;</td>";
echo "<td>".$red['country']."&nbsp;&nbsp;</td>";
echo "<td>".$red['date']."&nbsp;&nbsp;</td>";
if($red['status']=='0')
echo "<td><a href='editUser.php?status=1&id=".$red['id']."'>OFF</a></td>";
else
echo "<td><a href='editUser.php?status=0&id=".$red['id']."'>ON</a></td>";

echo "<td><a href='editUser.php?deleteid=".$red['id']."'>[ X ]</a></td>";
echo '</tr>';
}
?>
</table>
